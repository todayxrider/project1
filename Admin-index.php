...
{
$fe=mysql_query("select title,dname from reg_details where email='$_SESSION[username]'");
$row=mysql_fetch_array($fe);	
	}
else
{
echo "<script>alert('Kindly Login properly');
...
<html lang="en">
    ...
    <head>
        <title>Administrator Home-Massachussets General Hospital</title>
        <meta charset="utf-8" />
        ...
        <header class="header">
            <nav id="nav" class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="container relative-nav-container">
                    ...
                    <a class="navbar-brand scroll" href="admin-index.php">
                                    ...
                                    <div class=" inside-col">
                                        ...
                                        <ul class="inside-nav">
                                            ...
                                            <li><a href="#">Attendance & Payroll</a></li>
                                             ...
                                             <li><a href="#">Sms & Email</a></li></ul></div>
