...
function insert()
{
	$ins=mysql_query("insert into reg_details(title,dname,uname,upass,fname,lname,address,city,state,phone,email) values ('$_POST[tit]','$_POST[dn]','$_POST[un]','$_POST[up]','$_POST[fn]','$_POST[ln]','$_POST[add]','$_POST[city]','$_POST[state]','$_POST[ph]','$_POST[e_add]')");
...
<html lang="en">
    ...
    <head>
        <title>Registration-Massachussets General Hospital</title>
        <meta charset="utf-8" />
    ...
    <body >
        ...
        <section class="register-header">
            <div class="header-caption">
                ...
                <p class="small" style="color:white;">New Patient</p>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div>
                        ...
                        <p class="subhead" align="center">Register with Us: </p>				
                        
                        <p class="large" align="center">Let us make an Online Account for you so you can access your information and other details on the go..</p>
                    ...
                    <div class="col-md-6">
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs-alt nav-tabs-one" role="tablist">
                                ...
                                <li role="presentation" class="active"><a  href="#home" aria-controls="home" role="tab" data-toggle="tab">New Registration</a></li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="home">
                                   <form action="" id="aa" method="post">
                                 <table id="new_app" border=1 width="600">
                                 
                                 <tr>
                                 <td ><strong>Title:</strong></td>
                                 <td style="width:400px; padding-top: 10px;" width="232" Align="center" >
                                 
                                 <select name="tit" id="tit" style="width:328px; height:35px;">
                                 ...
                                 <td style="width:400px; padding-top: 10px;" width="232" Align="center" ><input type="text" name="dn" placeholder="Type Display Name" size="45"></td>
                                 </tr>
                                 
                                 
                                 <tr>
                                 <td ><strong>User Name:</strong></td>
                                 <td style="width:400px; padding-top: 10px;" width="232" Align="center"  ><input name="un" type="text" id="un" placeholder="Type user Name"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>Password:</strong></td>
                                 <td Align="center" style="padding-top: 10px;"><input name="up" type="password" id="up" placeholder="Type password"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td ><strong>First Name:</strong></td>
                                 <td Align="center" style="padding-top: 10px;"><input name="fn" type="text" id="fn" placeholder="Type First Namee"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>Last Name:</strong></td>
                                 <td Align="center" style="padding-top: 10px;"><input name="ln" type="text" id="ln" placeholder="Type Last Name"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>Address:</strong></td>
                                 <td Align="center" style="padding-top: 10px;"><input name="add" type="text" id="add" placeholder="Current Address"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>City:</strong></td>
                                 <td Align="center" style="padding-top: 10px;">
                                 <select name="city" id="city" style="width:328px; height:35px;">
                                 ...
                                 <td Align="center" style="padding-top: 10px;"><input name="state" type="text" id="state" placeholder="Enter Your State"  size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>Phone Number:</strong>&nbsp;   </td>
                                 <td Align="center" style="padding-top: 10px;"><input name="ph" type="text" id="ph" placeholder="Enter sContact Number" size="45"></td>
                                 </tr>
                                 
                                 <tr>
                                 <td><strong>Email Address:</strong>&nbsp;  </td>
                                 <td Align="center" style="padding-top: 10px;"><input name="e_add" type="text" id="e_add" placeholder="Enter Email Address"  size="45"></td>
                                 </tr>
                               
                                 
                                 <tr>
                                
                                 <td Align="center" colspan="2" style="padding-top: 30px;"><input name="reg" type="submit" class="btn btn-success btn-sm" id="clr" style="width:150px" value="Register">
                                 
                               &nbsp; &nbsp; &nbsp; <input name="Reset" type="reset" class="btn btn-success btn-sm" id="clr" style="width:150px" value="Clear"></td>
                                 </tr>
